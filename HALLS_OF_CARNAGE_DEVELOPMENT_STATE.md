...
- Okay you got the special blocks fully wrong, instead of replacing the whole column with the special block, each block in the collumn has a chance to be replaced by special block, kinda like a sub-pallete
- Make entrances into rooms in wide and open_halls generation types 3 blocks wide, so bigger monsters can fit through
- Improve trap placement in open_halls generation type, it takes way too long