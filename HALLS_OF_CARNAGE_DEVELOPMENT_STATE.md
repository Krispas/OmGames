...
- Optimize the open_halls corridor generation for faster loading times
- Add a new level type infernal_chambers which uses the wide corridor generation
- Add a new level type factory which uses the open_halls generation
- Create 1 room for each of these types, more will be added later manually
- in untold depths scenario, place them as floors 6 and 7 for testing purposes