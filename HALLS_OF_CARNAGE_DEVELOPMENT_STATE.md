...
- Add a new command /hoc recipes for all players. It will show list of all buildings and where to find their blueprints (of course, one must be first playing to view it), the menu should have other submenus for crafting buidlings, showing their recipes and what level those recipes od unlock