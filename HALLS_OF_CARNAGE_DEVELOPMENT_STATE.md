...
- When returning the player to lobby, restore their health to full, when starting a game, do the same, when loading a save, restore the health players had while saving.
- Overdrive spawner: Give the summoning attack triple weight in being selected if it was 5 seconds since one of the cooldowns expired.
