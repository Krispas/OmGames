...
- The recipe book is a little bit hard to read. When listing blueprint locations, do newline for each like list. Also for some reason it lists it like Factory normal, Deep Crypt normal. Cut the rarity stuff out. Same later for blueprints. Blueprint: Rare Blueprint: Grindstone... Who is supposed to ready that? Also why do you need to know grindstone blueprint is for grindstone?
