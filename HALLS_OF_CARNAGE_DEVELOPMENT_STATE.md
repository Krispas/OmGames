...
- Make it so when researching, only one of the prerequisites is needed instead of all of them. Make research grid-based, instead of dynamically fitting the research nodes, each node specifies its coordinates on the 9x5 grid. In the research UI, put the bottle with the research points on the bottom line so whole 5 rows above are free. As a part of this also rework the research tree based on another step in this development slice. Coordinates 1, 2 means first row second column.
- New research tree - I have added research.md, rework the research tree fully based on this file, look at the file how its structured and you will know what I mean
