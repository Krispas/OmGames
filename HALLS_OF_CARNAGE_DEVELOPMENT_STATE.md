...
- When using yaw on vegetation, dont forget your not rotating it from center, but from its lower corner.
- Make it possible for vegetation to spawn in corridors
- Instead off offseting the trident model, could you just display it as if it was in GUI? Pretty sure item models can do that. Only for the trident
- Make ravagers weaker