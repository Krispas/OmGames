...
public final class HallsTrapTypeLoader {
    ...
    private static Map<String, HallsTrapType> fallbackTypes() {
        ...
        add(types, "wall_spikes", "wall_spikes", 6, List.of(), Material.BLACK_CONCRETE, Material.AIR, Material.IRON_SWORD, "", 1.1f, Material.SPRUCE_PLANKS, 1, 1, 10, 12.0, 1.1, 70, 12, 2.4f);
        add(types, "falling_ice", "falling_ice", 9, List.of("frozen_halls"), Material.AIR, Material.POINTED_DRIPSTONE, Material.IRON_NUGGET, "", 1.0f, Material.SPRUCE_PLANKS, 1, 1, 10, 200.0, 1.0, 70, 1, 2.4f);
        add(types, "poison_darts", "poison_darts", 9, List.of("deep_crypt"), Material.DISPENSER, Material.AIR, Material.IRON_NUGGET, "", 1.0f, Material.SPRUCE_PLANKS, 1, 1, 10, 4.0, 5.5, 45, 1, 2.4f);
